...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'glow-sm': '0 0 10px -3px rgb(var(--accent-rgb) / 0.3)',
        'glow': '0 0 20px -5px rgb(var(--accent-rgb) / 0.4)',
        'glow-lg': '0 0 30px -5px rgb(var(--accent-rgb) / 0.5)',
      ...
      backgroundImage: {
        ...
        'gradient-accent': 'linear-gradient(135deg, var(--accent) 0%, var(--accent-hover) 50%, var(--accent-light) 100%)',
        'gradient-accent-purple': 'linear-gradient(135deg, var(--accent) 0%, #7c4dff 100%)',

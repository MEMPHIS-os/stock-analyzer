...
export default function CommandPalette({ open, onClose }: CommandPaletteProps) {
  ...
  const navItems = useMemo<PaletteItem[]>(
    () => [
      ...
      { id: 'nav-news', label: t('nav.news'), icon: Newspaper, keywords: 'nachrichten schlagzeilen news headlines press', run: () => go('/news') },
      { id: 'nav-upcoming', label: t('nav.upcoming'), icon: CalendarClock, keywords: 'earnings dividende ex-dividend quartalszahlen termine upcoming events', run: () => go('/upcoming') },
